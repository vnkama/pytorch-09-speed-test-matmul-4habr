...
def getAlgorithmTestCfg():
    ...
    if GRAPH_X_NAME == 'AGENTS_COUNT':
        shapes_cfgs.extend([
            ...
            # {'main_props': random_part, 'shape_props': [2, GRAPH_ROUTES_LEN_CONST]},
            ...
            # {'main_props': random_part, 'shape_props': [50000, GRAPH_ROUTES_LEN_CONST]},
            # {'main_props': random_part, 'shape_props': [70000, GRAPH_ROUTES_LEN_CONST]},
            # {'main_props': random_part, 'shape_props': [100000, GRAPH_ROUTES_LEN_CONST]},
